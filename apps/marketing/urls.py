...
urlpatterns = [
    ...
    path('interactions/<int:pk>/', views.InteractionDetailView.as_view(), name='interaction-detail'),
    path('interactions/create/', views.InteractionCreateView.as_view(), name='interaction-create'),
    path('interactions/<int:pk>/update/', views.InteractionUpdateView.as_view(), name='interaction-update'),
    ...
    path('lead-stages/<int:pk>/', views.LeadStageDetailView.as_view(), name='lead-stage-detail'),
    path('lead-stages/create/', views.LeadStageCreateView.as_view(), name='lead-stage-create'),
    path('lead-stages/<int:pk>/update/', views.LeadStageUpdateView.as_view(), name='lead-stage-update'),
]