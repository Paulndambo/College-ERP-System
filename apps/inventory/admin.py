...
from apps.inventory.models import Category, InventoryItem, StockIssue, StockReceipt
...
class StockReceiptAdmin(admin.ModelAdmin):
    list_display = ("inventory_item", "purchase_order", "vendor", "quantity_received", "remarks")
...
class StockIssueAdmin(admin.ModelAdmin):
    ...
    def get_queryset(self, request):
        return super().get_queryset(request).select_related("inventory_item", "issued_to", "issued_by")