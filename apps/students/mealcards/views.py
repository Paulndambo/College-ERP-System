    ...
    def get_queryset(self):
        ...
        if search_query:
            queryset = queryset.filter(
                ...
                Q(student__registration_number=search_query) |
                Q(student_user__first_name__icontains=search_query)
            )
...
def new_meal_card(request):
    if request.method == "POST":
        ...
        return redirect("mealcards")
    return render(request, "mealcards/new_meal_card.html")