...
urlpatterns = [
    ...
    path(
        "rooms-details/<int:pk>/",
        views.HostelRoomDetailView.as_view(),
        name="room-detail",
    ),
    path(
        "rooms/<int:pk>/update/",
        views.HostelRoomUpdateView.as_view(),
        name="room-update",
    ),
    path(
        "rooms/<int:pk>/delete/",
        views.HostelRoomDeleteAPIView.as_view(),
        name="room-delete",
    ),
    path(
        "rooms/available/",
        views.AvailableRoomsListView.as_view(),
        name="available-rooms",
    ),
    path(
        "<int:hostel_id>/rooms/",
        views.HostelRoomsByHostelView.as_view(),
        name="hostel-rooms",
    ),
    path(
        "rooms/<int:room_id>/occupants/",
        views.RoomOccupantsView.as_view(),
        name="room-occupants",
    ),
    # ========== BOOKING URLS ==========
    ...
    path(
        "bookings/<int:pk>/confirm-or-cancel/",
    ...
    path(
        "occupants/create/",
        views.AddStudentToRoomView.as_view(),
        name="add-student-to-room",
    ),
    # Remove student from room
    path(
        "occupants/remove/",
        views.RemoveStudentFromRoomView.as_view(),
        name="remove-student-from-room",
    ),
    # Move student to different room
    path(
        "occupants/update/",
        views.UpdateStudentRoomView.as_view(),
        name="update-student-room",
    ),
]
