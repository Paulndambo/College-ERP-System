...
from apps.studentsportal.money.views import (
    StudentFeesPaymentsAPIView,
    StudentFeeInvoicesAPIView,
    StudentFeeLedgerAPIView,
    StudentFeeStatementAPIView,
)
...
urlpatterns = [
    path(
        "fees-payments/",
        StudentFeesPaymentsAPIView.as_view(),
        name="student-fees-payments",
    ),
    path(
        "fees-invoices/",
        StudentFeeInvoicesAPIView.as_view(),
        name="student-fees-invoices",
    ),
    path("fees-ledger/", StudentFeeLedgerAPIView.as_view(), name="student-fees-ledger"),
    path(
        "fees-statement/",
        StudentFeeStatementAPIView.as_view(),
