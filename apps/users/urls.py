...
from .views import  ChangePasswordAPIView, ForgotPasswordAPIView, MyProfileUpdateView, MyProfileView, RegisterUserAPIView, ResetPasswordAPIView, UserLoginAPIView, UserLogoutAPIView, UserManageView, UserRoleCreateAPIView, VerifyEmailOTPView
urlpatterns = [
